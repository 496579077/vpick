...
tar -zcvf $CACHE_DIR/vpick.tgz -C $CACHE_DIR/$NAME .
...
mkdir -p $DIST
mv $BUILD_DIR/$NAME-$VERSION.tgz dist

echo "************************************************************"
echo "build vpick finished!"
echo "target file: $DIST/$NAME-$VERSION.tgz"
echo "************************************************************"
...
tar -zcvf $BUILD_DIR/$NAME-$VERSION_WIN64.tgz -C $BUILD_DIR $NAME-$VERSION_WIN64
mv $BUILD_DIR/$NAME-$VERSION_WIN64.tgz dist

echo "************************************************************"
echo "build win64 tools finished!"
echo "target file: $DIST/$NAME-$VERSION_WIN64.tgz"
echo "************************************************************"
